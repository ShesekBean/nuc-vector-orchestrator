...
### Person Following (port 8081)
```
POST http://192.168.1.71:8081/follow/start
→ Start following the closest person

POST http://192.168.1.71:8081/follow/start
Content-Type: application/json
{"target": "Ophir"}
→ Follow a specific named person (requires enrolled face)

POST http://192.168.1.71:8081/follow/stop
→ Stop following

GET http://192.168.1.71:8081/follow/status
...
### Photos & Vision
- "robot take a photo" → GET /capture → send JPEG as Signal attachment
...
### Person Following
- "robot follow me" → POST http://192.168.1.71:8084/follow/start
- "robot follow Ophir" → POST http://192.168.1.71:8084/follow/start {"target": "Ophir"}
- "robot stop following" → POST http://192.168.1.71:8084/follow/stop
...
```bash
curl -sf -X POST http://192.168.1.71:8084/follow/start
```
...
- Following service on port 8084 — supports generic and named person following
